...
class InfoPagesExpressions {
  ...
  public static class InfoPagesExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'location' attribute on LocationGroup (id=InfoPages) at InfoPages.pcf: line 58, column 37
    function action_30 () : void {
      pcf.LoadHistoryInfo.go()
    }
    
    // 'location' attribute on LocationGroup (id=InfoPages) at InfoPages.pcf: line 61, column 41
    function action_32 () : void {
      pcf.LoadIntegrityChecks.go()
    }
    
    // 'location' attribute on LocationGroup (id=InfoPages) at InfoPages.pcf: line 64, column 36
    function action_34 () : void {
      pcf.LoadErrorsInfo.go()
    }
    
    // 'location' attribute on LocationGroup (id=InfoPages) at InfoPages.pcf: line 67, column 44
    function action_36 () : void {
      pcf.RuntimeEnvironmentInfo.go()
    }
    
    // 'location' attribute on LocationGroup (id=InfoPages) at InfoPages.pcf: line 70, column 45
    ...
    // 'location' attribute on LocationGroup (id=InfoPages) at InfoPages.pcf: line 73, column 39
    function action_40 () : void {
      pcf.LoadedGosuClasses.go()
    }
    
    // 'location' attribute on LocationGroup (id=InfoPages) at InfoPages.pcf: line 75, column 39
